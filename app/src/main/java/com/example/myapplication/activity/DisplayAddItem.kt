        ...
        return when (itemType) {
            "Book" -> {
                ...
                val author =
                    binding.editSecondOptional.text.toString().takeIf { it.isNotBlank() } ?: run {
                        binding.editSecondOptional.error = resources.getString(R.string.error_enter_author)
                        return null
                    }
            ...
            "Newspaper" -> {
                ...
                val month = try {
                    ...
                    binding.editSecondOptional.error = resources.getString(R.string.error_enter_month)
                    return null
                }
